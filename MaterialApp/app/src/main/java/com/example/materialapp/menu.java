...
public class menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd1.setOnClickListener(view -> {
            ...
            Intent update = new Intent(menu.this, com.example.materialapp.ket1.class);
        ...
        cd2.setOnClickListener(view -> {
            int updateTotal = terima.getIntExtra("total",0);
            int updateHarga = terima.getIntExtra("harga",0);
            Intent update = new Intent(menu.this, ket2.class);
            update.putExtra("update", updateTotal);
            update.putExtra("update2",updateHarga);
            startActivity(update);
        });
        ...
        cd3.setOnClickListener(view -> {
            int updateTotal = terima.getIntExtra("total",0);
            int updateHarga = terima.getIntExtra("harga",0);
            Intent update = new Intent(menu.this, com.example.materialapp.ket3.class);
            update.putExtra("update", updateTotal);
            update.putExtra("update2",updateHarga);
            startActivity(update);
        });
        ...
        cd4.setOnClickListener(view -> {
            int updateTotal = terima.getIntExtra("total",0);
            int updateHarga = terima.getIntExtra("harga",0);
            Intent update = new Intent(menu.this, com.example.materialapp.ket4.class);
            update.putExtra("update", updateTotal);
            update.putExtra("update2",updateHarga);
            startActivity(update);
        });
        ...
        cd5.setOnClickListener(view -> {
            int updateTotal = terima.getIntExtra("total",0);
            int updateHarga = terima.getIntExtra("harga",0);
            Intent update = new Intent(menu.this, com.example.materialapp.ket5.class);
            update.putExtra("update", updateTotal);
            update.putExtra("update2",updateHarga);
            startActivity(update);
        });
        cd6.setOnClickListener(view -> {
            int updateTotal = terima.getIntExtra("total",0);
            int updateHarga = terima.getIntExtra("harga",0);
            Intent update = new Intent(menu.this, com.example.materialapp.ket6.class);
            update.putExtra("update", updateTotal);
            update.putExtra("update2",updateHarga);
            startActivity(update);
        });
        ...
        harga.setOnClickListener(view -> {
            ...
            Intent kirim = new Intent(menu.this, formulir.class);
